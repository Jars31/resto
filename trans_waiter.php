...
<body>
	<nav>
		<ul>
			<li><a href="dash_waiter.php" style="font-family: Century Gothic">Dashboard</a></li>
	...
	<br>
	<br><br>
	<center><h1 style="font-family:Century Gothic; color:rgba(10,101,146);">Form Transaksi</h1>
