...
<div class="container">
	<nav>
		<ul>
			...
			<li><a href="menu_waiter.php" style="font-family: Century Gothic">Entri Barang</a></li>
			<li><a href="trans_waiter.php" style="font-family: Century Gothic">Transaksi</a></li>
			<li><a href ="laporan_waiter.php" style="font-family: Century Gothic">Laporan</a></li>
	...
	<center><h3 style="font-family: Century Gothic;">Anda Masuk Sebagai Waiter</h3></center>
</div>
